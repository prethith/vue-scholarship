...
.choiceBtn:hover {
  background-color: #3c3c3c; /* Darker shade for hover effect */
  color: #fff;
  cursor: pointer;
...
.logoutBtn:hover {
  background-color: #614c4c; /* Darker red on hover */
}
...
/* Button Styles */
.AddScholarship {
  background-color: #357260; /* Green color for a fresh look */
...
.AddScholarship:hover {
  background-color: #4a8173; /* Darker green on hover */
  transform: translateY(-2px); /* Slight lift effect */
}

.AddScholarship:active {
  background-color: #048e5b; /* Even darker green on click */
  transform: translateY(0); /* Reset lift effect */
}
